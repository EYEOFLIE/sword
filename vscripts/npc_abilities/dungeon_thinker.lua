			...
			Timers:CreateTimer(5.3, function()
				...
				Timers:CreateTimer(1.2, function()
					...
					for i = 1, #pugnaTable, 1 do
						...
						local trueForm = Dungeons:SpawnDungeonUnit("summoner_true_form", pugnaPos, 1, 2, 4, "Hero_Undying.FleshGolem.Cast", Vector(0,-1), true, nil)
...
function prepareAssaultQuest()
  ...
  Timers:CreateTimer(6, function()
	  CreateUnitByName("gazbin_guard", Vector(-13120, -6976), true, nil, nil, DOTA_TEAM_NEUTRALS)
	  CreateUnitByName("gazbin_guard", Vector(-13120, -7936), true, nil, nil, DOTA_TEAM_NEUTRALS)
	  for i = 0, 1, 1 do
