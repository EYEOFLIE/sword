...
function BasicSkill:Evaluate()
	local desire = 0
	print("evaluate nevermore_requiem skill")

	-- let's not choose this twice in a row
	if currentBehavior == self then return desire end

	self.baseAbility = thisEntity:FindAbilityByName( "nevermore_requiem" )
...
function DiveSkill:Evaluate()
	...
	self.diveAbility = thisEntity:FindAbilityByName( "lina_dragon_slave" )
