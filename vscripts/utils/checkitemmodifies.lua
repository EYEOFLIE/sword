function RemoveInvalidModifies(hero,ItemName,ModifierName)
	--PrintTestLog(("RemoveInvalidModifies| ItemName:"..ItemName.." ModifierName:"..ModifierName)
	local ItemCount=0
	for i=0,5 do
...
function CheckItemModifies(hero)
	--PrintTestLog(("CheckItemModifies!")
	...
	for i=0,hero:GetModifierCount()-1 do
		...
		local ItemName=nil
		--PrintTestLog(("Modifier Index:"..tostring(i).." Name:"..ModifierName)
		if ModifierClass then
			...
			--PrintTestLog(("CheckCount:"..tostring(CheckCount))
