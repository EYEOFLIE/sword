...
function RPCItems:RollHoodProperty1(item, xpBounty, randomHelm)
    ...
    elseif luck >= 90 and luck < 100 then
        ...
        value, suffixLevel = RPCItems:RollAttribute(xpBounty, 1, 4+bonus, 0, 0, item.rarity, false, maxFactor)
        item.property1 = value
...
function RPCItems:RollHoodProperty3(item, xpBounty)
    ...
    elseif luck >= 40 and luck < 50 then
        value, nameLevel = RPCItems:RollAttribute(xpBounty, 1, 10, 0, 0, item.rarity, false, maxFactor*3)
        item.property3 = value
    ...
    elseif luck >= 90 and luck < 100 then
        value, nameLevel = RPCItems:RollAttribute(xpBounty, 1, 5, 0, 0, item.rarity, false, maxFactor)
        item.property3 = value
